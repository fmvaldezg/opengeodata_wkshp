...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, frame hidden, enhanced, interior hidden, breakable, boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}]}{\end{tcolorbox}}\fi
...
\hypertarget{why-open-geospatial-data}{%
\section{Why Open Geospatial Data?}\label{why-open-geospatial-data}}

\hypertarget{sources-reviewed-in-this-tutorial}{%
